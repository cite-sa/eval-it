...
import { DataObjectTagFilter } from '@app/core/query/data-object-tag.lookup';
import { TagType } from '@app/core/enum/tag-type.enum';

@Component({
	selector: 'app-data-object-tag-listing-filters',
	templateUrl: './data-object-tag-listing-filters.component.html',
	styleUrls: ['./data-object-tag-listing-filters.component.scss']
})
export class DataObjectTagListingFiltersComponent extends BaseComponent implements OnInit, OnChanges {

	@Input() filter: DataObjectTagFilter;
	@Output() filterChange = new EventEmitter<DataObjectTagFilter>();
	// panelExpanded = false;
	...
	//
	visibleFields(filter: DataObjectTagFilter) {
