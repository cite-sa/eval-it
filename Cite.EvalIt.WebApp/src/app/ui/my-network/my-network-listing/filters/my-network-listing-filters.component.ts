...
@Component({
	selector: 'app-my-network-listing-filters',
	templateUrl: './my-network-listing-filters.component.html',
	styleUrls: ['./my-network-listing-filters.component.scss']
})
export class MyNetworkListingFiltersComponent extends BaseComponent implements OnInit, OnChanges {
	...
	visibleFields(filter: AppUserNetworkFilter) {
		...
		this.filterSelections['relationshipOption'] = (filter.like && filter.like.length !== 0) ? true : false;
	}
