...
import { WhatYouKnowAboutMeDecline } from '@user-service/core/model/what-you-know-about-me.model';

export class WhatYouKnowAboutMeDeclineModel implements WhatYouKnowAboutMeDecline {
	public text: string;
	public token: string;
