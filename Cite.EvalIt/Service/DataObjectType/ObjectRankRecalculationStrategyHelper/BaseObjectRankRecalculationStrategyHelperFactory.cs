...
{
    public class BaseObjectRankRecalculationStrategyHelperFactory<T, IT> where T : struct, IConvertible /*enum constraint*/
                                                                        where IT : class
    {
        public class BaseObjectRankRecalculationStrategyHelperFactoryConfig
        {
            public Dictionary<T, Type> Accessors { get; } = new Dictionary<T, Type>();

            public BaseObjectRankRecalculationStrategyHelperFactoryConfig Add(T key, Type type)
            {
        ...
        public BaseObjectRankRecalculationStrategyHelperFactory(IServiceProvider serviceProvider, Microsoft.Extensions.Options.IOptions<BaseObjectRankRecalculationStrategyHelperFactoryConfig> config, ErrorThesaurus errors)
        {
