...
{
    public class EvaluationOptionHelperFactory<T, IT> where T : struct, IConvertible /*enum constraint*/
                                                                        where IT : class
    {
        public class EvaluationOptionHelperFactoryConfig
        {
            public Dictionary<T, Type> Accessors { get; } = new Dictionary<T, Type>();

            public EvaluationOptionHelperFactoryConfig Add(T key, Type type)
            {
        ...
        public EvaluationOptionHelperFactory(IServiceProvider serviceProvider, Microsoft.Extensions.Options.IOptions<EvaluationOptionHelperFactoryConfig> config, ErrorThesaurus errors)
        {
