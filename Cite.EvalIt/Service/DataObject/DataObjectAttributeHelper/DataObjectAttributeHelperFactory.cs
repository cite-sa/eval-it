...
{
    public class DataObjectAttributeHelperFactory<T, IT> where T : struct, IConvertible /*enum constraint*/
                                                                        where IT : class
    {
        public class DataObjectAttributeHelperFactoryConfig
        {
            public Dictionary<T, Type> Accessors { get; } = new Dictionary<T, Type>();

            public DataObjectAttributeHelperFactoryConfig Add(T key, Type type)
            {
        ...
        public DataObjectAttributeHelperFactory(IServiceProvider serviceProvider, Microsoft.Extensions.Options.IOptions<DataObjectAttributeHelperFactoryConfig> config, ErrorThesaurus errors)
        {
