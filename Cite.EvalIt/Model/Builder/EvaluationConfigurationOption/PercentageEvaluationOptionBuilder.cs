...
{
    public class PercentageEvaluationOptionBuilder : Builder<BaseEvaluationOption, Data.BaseEvaluationOption>
    {
        public PercentageEvaluationOptionBuilder(
        ...
        public override Task<List<BaseEvaluationOption>> Build(IFieldSet fields, IEnumerable<Data.BaseEvaluationOption> datas)
        {
            ...
            foreach (Data.PercentageEvaluationOption d in datas)
            {
                PercentageEvaluationOption m = new PercentageEvaluationOption();
                if (fields.HasField(this.AsIndexer(nameof(PercentageEvaluationOption.UpperBound)))) m.UpperBound = d.UpperBound;
                if (fields.HasField(this.AsIndexer(nameof(PercentageEvaluationOption.LowerBound)))) m.LowerBound = d.LowerBound;
        ...
        protected IFieldSet GetAllEvaluation()
        {
            ...
            fieldStrings = fieldStrings.Append(this.AsIndexer(nameof(PercentageEvaluationOption.UpperBound)));
            fieldStrings = fieldStrings.Append(this.AsIndexer(nameof(PercentageEvaluationOption.LowerBound)));
