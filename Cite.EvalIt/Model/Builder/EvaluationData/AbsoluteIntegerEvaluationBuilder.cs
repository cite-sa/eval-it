...
{
    public class AbsoluteIntegerEvaluationBuilder : Builder<ReviewEvaluation, Data.ReviewEvaluation>
    {
        public AbsoluteIntegerEvaluationBuilder(
        ...
        public override Task<List<ReviewEvaluation>> Build(IFieldSet fields, IEnumerable<Data.ReviewEvaluation> datas)
        {
            ...
            foreach (Data.AbsoluteIntegerEvaluation d in datas)
            {
                AbsoluteIntegerEvaluation m = new AbsoluteIntegerEvaluation();
                if (fields.HasField(this.AsIndexer(nameof(AbsoluteIntegerEvaluation.Values)))) m.Values = d.Values;
