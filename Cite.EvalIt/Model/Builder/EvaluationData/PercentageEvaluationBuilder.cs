...
{
    public class PercentageEvaluationBuilder : Builder<ReviewEvaluation, Data.ReviewEvaluation>
    {
        public PercentageEvaluationBuilder(
        ...
        public override Task<List<ReviewEvaluation>> Build(IFieldSet fields, IEnumerable<Data.ReviewEvaluation> datas)
        {
            ...
            foreach (Data.PercentageEvaluation d in datas)
            {
                PercentageEvaluation m = new PercentageEvaluation();
                if (fields.HasField(this.AsIndexer(nameof(PercentageEvaluation.Values)))) m.Values = d.Values;
