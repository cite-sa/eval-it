...
{
    public class SelectionEvaluationBuilder : Builder<ReviewEvaluation, Data.ReviewEvaluation>
    {
        public SelectionEvaluationBuilder(
        ...
        public override Task<List<ReviewEvaluation>> Build(IFieldSet fields, IEnumerable<Data.ReviewEvaluation> datas)
        {
            ...
            foreach (Data.SelectionEvaluation d in datas)
            {
                SelectionEvaluation m = new SelectionEvaluation();
                if (fields.HasField(this.AsIndexer(nameof(SelectionEvaluation.Values)))) m.Values = d.Values;
