...
{
    public class AbsoluteDecimalEvaluationBuilder : Builder<ReviewEvaluation, Data.ReviewEvaluation>
    {
        public AbsoluteDecimalEvaluationBuilder(
        ...
        public override Task<List<ReviewEvaluation>> Build(IFieldSet fields, IEnumerable<Data.ReviewEvaluation> datas)
        {
            ...
            foreach (Data.AbsoluteDecimalEvaluation d in datas)
            {
                AbsoluteDecimalEvaluation m = new AbsoluteDecimalEvaluation();
                if (fields.HasField(this.AsIndexer(nameof(AbsoluteDecimalEvaluation.Values)))) m.Values = d.Values;
