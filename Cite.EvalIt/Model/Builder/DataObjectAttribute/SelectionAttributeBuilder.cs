...
{
    public class SelectionAttributeBuilder : Builder<DataObjectAttribute, Data.DataObjectAttribute>
    {
        public SelectionAttributeBuilder(
        ...
        public override Task<List<DataObjectAttribute>> Build(IFieldSet fields, IEnumerable<Data.DataObjectAttribute> datas)
        {
            ...
            foreach (Data.SelectionAttribute d in datas)
            {
                SelectionAttribute m = new SelectionAttribute();
                if (fields.HasField(this.AsIndexer(nameof(SelectionAttribute.Values)))) m.Values = d.Values;
