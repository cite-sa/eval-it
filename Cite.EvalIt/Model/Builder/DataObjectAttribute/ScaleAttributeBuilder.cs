...
{
    public class ScaleAttributeBuilder : Builder<DataObjectAttribute, Data.DataObjectAttribute>
    {
        public ScaleAttributeBuilder(
        ...
        public override Task<List<DataObjectAttribute>> Build(IFieldSet fields, IEnumerable<Data.DataObjectAttribute> datas)
        {
            ...
            foreach (Data.ScaleAttribute d in datas)
            {
                ScaleAttribute m = new ScaleAttribute();
                if (fields.HasField(this.AsIndexer(nameof(ScaleAttribute.Values)))) m.Values = d.Values;
