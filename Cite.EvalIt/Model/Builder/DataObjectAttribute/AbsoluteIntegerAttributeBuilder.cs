...
{
    public class AbsoluteIntegerAttributeBuilder : Builder<DataObjectAttribute, Data.DataObjectAttribute>
    {
        public AbsoluteIntegerAttributeBuilder(
        ...
        public override Task<List<DataObjectAttribute>> Build(IFieldSet fields, IEnumerable<Data.DataObjectAttribute> datas)
        {
            ...
            foreach (Data.AbsoluteIntegerAttribute d in datas)
            {
                AbsoluteIntegerAttribute m = new AbsoluteIntegerAttribute();
                if (fields.HasField(this.AsIndexer(nameof(AbsoluteIntegerAttribute.Values)))) m.Values = d.Values;
