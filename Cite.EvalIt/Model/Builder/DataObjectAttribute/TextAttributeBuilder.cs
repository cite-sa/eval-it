...
{
    public class TextAttributeBuilder : Builder<DataObjectAttribute, Data.DataObjectAttribute>
    {
        ...
        public override Task<List<DataObjectAttribute>> Build(IFieldSet fields, IEnumerable<Data.DataObjectAttribute> datas)
        {
            ...
            foreach (Data.TextAttribute d in datas)
            {
                TextAttribute m = new TextAttribute();
                if (fields.HasField(this.AsIndexer(nameof(TextAttribute.Values)))) m.Values = d.Values;
